...
export declare const zmqVersion: any;
/**
...
export declare class ZeroMq {
     ...
     */
    onConnected(listener: (eventValue: number, eventEndpointAddress: string, error?: string) => void): void;
    /**
     * A connect request on the socket is pending. The event value is unspecified.
     */
    onConnectDelayed(listener: (eventValue: number, eventEndpointAddress: string, error?: string) => void): void;
    /**
     ...
     */
    onConnectRetried(listener: (eventValue: number, eventEndpointAddress: string, error?: string) => void): void;
    /**
     ...
     * this event.
     */
    onListening(listener: (eventValue: number, eventEndpointAddress: string, error?: string) => void): void;
    /**
     * The socket could not bind to a given interface. The event value is the errno generated by the system
     * bind call.
     */
    onBindFailed(listener: (eventValue: number, eventEndpointAddress: string, error?: string) => void): void;
    /**
     * The socket has accepted a connection from a remote peer. The event value is the FD of the underlying
     * network socket. Warning: there is no guarantee that the FD is still valid by the time your code receives
     * this event.
     */
    onAccepted(listener: (eventValue: number, eventEndpointAddress: string, error?: string) => void): void;
    /**
     * The socket has rejected a connection from a remote peer. The event value is the errno generated by the
     * accept call.
     */
    onAcceptFailed(listener: (eventValue: number, eventEndpointAddress: string, error?: string) => void): void;
    /**
     * The socket was closed. The event value is the FD of the (now closed) network socket.
     */
    onClosed(listener: (eventValue: number, eventEndpointAddress: string, error?: string) => void): void;
    /**
     ...
     */
    onCloseFailed(listener: (eventValue: number, eventEndpointAddress: string, error?: string) => void): void;
    /**
     ...
     */
    onDisconnected(listener: (eventValue: number, eventEndpointAddress: string, error?: string) => void): void;
     ...
     * @param callback
     */
    send(message: string | any[] | Buffer, flags?: number, callback?: (error: Error) => void): void;
}
/**
 * ØMQ provides the the following transports:
 *
