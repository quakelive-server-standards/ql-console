...
exports.PlayerStatsEvent = void 0;
 ...
 */
var PlayerStatsEvent = /** @class */ (function () {
    function PlayerStatsEvent() {
    }
    PlayerStatsEvent.fromQl = function (data) {
        var event = new PlayerStatsEvent;
        ...
        event.team = data['TEAM'] == 1 ? TeamType_1.TeamType.RED : data['TEAM'] == 2 ? TeamType_1.TeamType.BLUE : TeamType_1.TeamType.FREE;
...
exports.PlayerStatsEvent = PlayerStatsEvent;
